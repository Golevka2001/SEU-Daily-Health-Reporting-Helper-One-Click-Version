...
- [东南大学每日健康上报打卡助手（Windows 一键部署版） :alarm\_clock:](#东南大学每日健康上报打卡助手windows-一键部署版-alarm_clock)
...
> 在此项目之前的更新日志可查看 [README.md](https://github.com/Golevka2001/SEU-Daily-Health-Reporting-Helper/blob/multiusr/README.md)

**2022.10.30:**

1. 开始运行前检查网络连接状况，若无连接则暂停，等待用户确认后再次运行。
